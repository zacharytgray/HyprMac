...
final class KeybindDecoderToleranceTests: XCTestCase {
    ...
    func testFocusDirectionWireFormatDecodes() throws {
        ...
        XCTAssertEqual(kb.action.toAction(), .focusDirection(.left))
    ...
    func testSwapDirectionWireFormatDecodes() throws {
        ...
        let kb = try JSONDecoder().decode(Keybind.self, from: Data(json.utf8))
        XCTAssertEqual(kb.action.toAction(), .swapDirection(.down))
    ...
    func testMoveWorkspaceToMonitorWireFormatDecodes() throws {
        ...
        let kb = try JSONDecoder().decode(Keybind.self, from: Data(json.utf8))
        XCTAssertEqual(kb.action.toAction(), .moveWorkspaceToMonitor(.left))
    ...
    func testMalformedFocusDirectionFallsBack() throws {
        ...
        XCTAssertEqual(kb.action.toAction(), .focusDirection(.right))
    }
    ...
    func testMalformedSwapDirectionFallsBack() throws {
        ...
        let kb = try JSONDecoder().decode(Keybind.self, from: Data(json.utf8))
        XCTAssertEqual(kb.action.toAction(), .swapDirection(.right))
    }
    ...
    func testMalformedMoveWorkspaceDirectionFallsBack() throws {
        ...
        let kb = try JSONDecoder().decode(Keybind.self, from: Data(json.utf8))
        XCTAssertEqual(kb.action.toAction(), .moveWorkspaceToMonitor(.right))
    }
    ...
    func testMixedActionShapesInArrayDecode() throws {
        ...
        XCTAssertEqual(kbs[0].action.toAction(), .focusDirection(.down))
        XCTAssertEqual(kbs[1].action.toAction(), .toggleFloating)
        XCTAssertEqual(kbs[2].action.toAction(), .cycleWorkspace(-1))
        XCTAssertEqual(kbs[3].action.toAction(), .launchApp(bundleID: "com.apple.Terminal"))
    }
